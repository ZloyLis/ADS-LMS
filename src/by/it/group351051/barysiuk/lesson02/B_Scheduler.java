...
public class B_Scheduler {
    ...
    List<Event> calcStartTimes(Event[] events, int from, int to) {
        ...
        // Сортировка по полю "stop" (время завершения события)
