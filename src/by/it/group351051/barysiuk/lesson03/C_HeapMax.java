...
public class C_HeapMax {
    ...
    private static class MaxHeap {
        ...
        int siftDown(int i) { //просеивание вверх
            ...
            if (i != maxIndex) {
                // Меняем текущий элемент с максимальным из потомков
                swap(i, maxIndex);
                siftDown(maxIndex); // Рекурсивно просеиваем вниз
            }
            return i;
        }
        ...
        int siftUp(int i) { //просеивание вниз
            while (i > 0) {
                int parent = (i - 1) / 2; // Родительский индекс
        ...
        Long extractMax() { //извлечение и удаление максимума
            ...
            Long result = heap.getFirst(); // Максимальный элемент — это корень
            heap.set(0, heap.getLast()); // Переносим последний элемент в корень
        ...
        // Свой метод для обмена элементов
